...
<div class="contact-form__content">
   ...
   <form class="form" action="/attendance/end" method="post">
    ...
    <div class="flex__button">
      ...
      <div class="form__button">
        ...
        <button class="form__button-submit-2" type="submit" name="button1" value="ボタン1">勤務開始</button>
      ...
      <div class="form__button">
        ...
        <button disabled class="form__button-submit" type="submit" name="button2" value="ボタン2" >勤務終了</button>
  ...
  <form class="form" action="/attendance/start" method="post">
    <div class="flex__button">
         @csrf
